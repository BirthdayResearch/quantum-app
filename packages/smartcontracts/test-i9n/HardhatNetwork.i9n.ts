...
import { HardhatNetwork, HardhatNetworkContainer, StartedHardhatNetworkContainer, TX_AUTOMINE_ENV_VAR } from '../src';

describe('HardhatNetwork', () => {
  describe('StartedHardhatNetworkContainer behaviour', () => {
    ...
    it('should be connectable via RPC', async () => {
      ...
      // Can also be found in the hardhat config in hardhat.config.ts in packages/smartcontracts
